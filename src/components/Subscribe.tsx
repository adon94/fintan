...
// const database =
//   "https://www.notion.so/992a684411b94dc2b84da4f1a8415454?v=71c8abf59a9545e9ab03cb038a47dfc7";
...
function Subscribe() {
  ...
  function storeEmail(e: FormEvent<HTMLFormElement>) {
    ...
    const options = {
      method: "PATCH",
      url: "https://api.notion.com/v1/databases/992a684411b94dc2b84da4f1a8415454",
      headers: {
